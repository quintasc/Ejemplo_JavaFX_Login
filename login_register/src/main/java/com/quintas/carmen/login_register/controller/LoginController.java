...
public class LoginController {
    ...
    /**
     * Este método está conectado al botón "Entrar" en el archivo FXML.
     * Solo se ejecuta cuando el usuario hace clic. No recibe parámetros raros.
     */
    @FXML
    public void onLoginClick() {
        ...
        if (UserDataValidations.hayCamposVacios(usuarioEscrito, passwordEscrita)) {
        ...
        } else if (!UserDataValidations.esPasswordSegura(passwordEscrita)) {
        ...
        } else if (UserDataValidations.sonCredencialesCorrectas(usuarioEscrito, passwordEscrita)) {
            
            lblInfo.setText("¡Bienvenido al sistema!");
